...
import {xml as xml2} from "./xml.js";
...
describe("VDOM", () => {
  ...
  it("should have functional factory", () => {
    ...
    doc.body.replaceChildren(h("p", {class: "lorem"}, "Hello ", h("b", {id: "foo"}, "World")), h("hr"));
    let r = doc.body;
  ...
  it("should use JSX", () => {
    ...
    expect(s.render(xml2)).toEqual('<a href="example.com" x="x" onclick="return false" title="Hello" id="greeting"><hr /><b>Welcome</b></a>');
  });
  it("should nested JSX", () => {
    let content = /* @__PURE__ */ h("div", null, "Hello");
    let title = "World";
    let doc = /* @__PURE__ */ h("body", null, /* @__PURE__ */ h("h1", null, title), content);
    expect(doc.render()).toBe("<body><h1>World</h1><div>Hello</div></body>");
  });
  it("should JSX components", () => {
    function Welcome({props, h: h2}) {
      return /* @__PURE__ */ h2("h1", null, "Hello, ", props.name);
    }
    let x = /* @__PURE__ */ h(Welcome, {
      name: "Sara"
    });
  ...
  it("should support fragments", () => {
    let ff = /* @__PURE__ */ h("fragment", null, /* @__PURE__ */ h("div", null, "One"), "Middle", /* @__PURE__ */ h("div", null, "Two"));
    expect(ff).toBeInstanceOf(VDocumentFragment);
    expect(ff.render()).toEqual("<div>One</div>Middle<div>Two</div>");
  });
  it("should remove", () => {
    let el = /* @__PURE__ */ h("div", null, /* @__PURE__ */ h("div", {
      id: "a"
    }), /* @__PURE__ */ h("div", {
      id: "b"
    }, "Before", /* @__PURE__ */ h("link", {
      rel: "stylesheet",
      href: ""
    }), /* @__PURE__ */ h("span", null, "After")));
  ...
  it("should insert", () => {
    let el = /* @__PURE__ */ h("div", null, /* @__PURE__ */ h("p", null, "Hallo"));
    let w = /* @__PURE__ */ h("h1", null, "Welcome");
    el.insertBefore(w);
    expect(el.render()).toEqual("<div><h1>Welcome</h1><p>Hallo</p></div>");
    el.insertBefore(w, w);
    el.insertBefore(/* @__PURE__ */ h("div", null, "Subtitle"), el.querySelector("p"));
    expect(el.render()).toEqual("<div><h1>Welcome</h1><div>Subtitle</div><p>Hallo</p></div>");
  });
});
//# sourceMappingURL=vdom.spec.js.map
